...
class QDeclarativeEditViewPrivate {
public:
    QDeclarativeEditViewPrivate(QDeclarativeEditView* qq)
      : q(qq)
      , preferredwidth(0)
      , preferredheight(0)
      , progress(1.0)
      , status(QDeclarativeEditView::Null)
      , pending(PendingNone)
    ...
    {
        static_cast<QDeclarativeEditViewPrivate*>(prop->data)->windowObjects.append(o);
        static_cast<QDeclarativeEditViewPrivate*>(prop->data)->updateWindowObjects();
    }
...
GraphicsEditView::GraphicsEditView(QDeclarativeEditView* parent)
...
void GraphicsEditView::mousePressEvent(QGraphicsSceneMouseEvent* event)
{
...
void GraphicsEditView::mouseReleaseEvent(QGraphicsSceneMouseEvent* event)
{
...
void GraphicsEditView::mouseDoubleClickEvent(QGraphicsSceneMouseEvent* event)
{
...
void GraphicsEditView::timerEvent(QTimerEvent* event)
{
...
void GraphicsEditView::mouseMoveEvent(QGraphicsSceneMouseEvent* event)
{
...
bool GraphicsEditView::sceneEvent(QEvent *event)
{
...
/*!
    \qmlclass WebView QDeclarativeEditView
...
/*!
    \internal
    \class QDeclarativeEditView
    \brief The QDeclarativeEditView class allows you to add web content to a QDeclarativeView.
    ...
    A QDeclarativeEditView object can be instantiated in Qml using the tag \l WebView.
*/

QDeclarativeEditView::QDeclarativeEditView(QDeclarativeItem *parent) : QDeclarativeItem(parent)
{
    init();
}

QDeclarativeEditView::~QDeclarativeEditView()
{
    delete d;
}

void QDeclarativeEditView::init()
{
    d = new QDeclarativeEditViewPrivate(this);
    ...
    d->view = new GraphicsEditView(this);
    d->view->setResizesToContents(true);
    d->view->setFocus();
    QWebPage* wp = new QDeclarativeEditPage(this);
    setPage(wp);
    if (!preferredWidth())
...
void QDeclarativeEditView::componentComplete()
{
    QDeclarativeItem::componentComplete();
    page()->setNetworkAccessManager(qmlEngine(this)->networkAccessManager());

    switch (d->pending) {
    case QDeclarativeEditViewPrivate::PendingUrl:
        setUrl(d->pendingUrl);
        break;
    case QDeclarativeEditViewPrivate::PendingHtml:
        setHtml(d->pendingString, d->pendingUrl);
        break;
    case QDeclarativeEditViewPrivate::PendingContent:
        setContent(d->pendingData, d->pendingString, d->pendingUrl);
        break;
    default:
        break;
    }
    d->pending = QDeclarativeEditViewPrivate::PendingNone;
    d->updateWindowObjects();
}

QDeclarativeEditView::Status QDeclarativeEditView::status() const
{
    return d->status;
}
...
*/
qreal QDeclarativeEditView::progress() const
{
    return d->progress;
}

void QDeclarativeEditView::doLoadStarted()
{
    if (!d->url.isEmpty()) {
        d->status = Loading;
...
void QDeclarativeEditView::doLoadProgress(int p)
{
...
void QDeclarativeEditView::pageUrlChanged()
{
    updateContentsSize();
...
void QDeclarativeEditView::doLoadFinished(bool ok)
{
    if (ok) {
...
*/
QUrl QDeclarativeEditView::url() const
{
    return d->url;
}

void QDeclarativeEditView::setUrl(const QUrl& url)
{
    if (url == d->url)
        return;
...
*/
int QDeclarativeEditView::preferredWidth() const
{
    return d->preferredwidth;
}

void QDeclarativeEditView::setPreferredWidth(int width)
{
...
*/
int QDeclarativeEditView::preferredHeight() const
{
    return d->preferredheight;
}

void QDeclarativeEditView::setPreferredHeight(int height)
{
...
*/
QVariant QDeclarativeEditView::evaluateJavaScript(const QString& scriptSource)
{
    return this->page()->mainFrame()->evaluateJavaScript(scriptSource);
}

void QDeclarativeEditView::updateDeclarativeWebViewSize()
{
...
void QDeclarativeEditView::initialLayout()
{
    // nothing useful to do at this point
}

void QDeclarativeEditView::updateContentsSize()
{
    if (page()) {
...
void QDeclarativeEditView::geometryChanged(const QRectF& newGeometry, const QRectF& oldGeometry)
{
...
*/
QDeclarativeListProperty<QObject> QDeclarativeEditView::javaScriptWindowObjects()
{
    return QDeclarativeListProperty<QObject>(this, d, &QDeclarativeEditViewPrivate::windowObjectsAppend);
}

QDeclarativeEditViewAttached* QDeclarativeEditView::qmlAttachedProperties(QObject* o)
{
    return new QDeclarativeEditViewAttached(o);
}

void QDeclarativeEditViewPrivate::updateWindowObjects()
{
    ...
    for (int i = 0; i < windowObjects.count(); ++i) {
        ...
        QDeclarativeEditViewAttached* attached = static_cast<QDeclarativeEditViewAttached *>(qmlAttachedPropertiesObject<QDeclarativeEditView>(object));
...
bool QDeclarativeEditView::renderingEnabled() const
{
    return d->rendering;
}

void QDeclarativeEditView::setRenderingEnabled(bool enabled)
{
...
*/
bool QDeclarativeEditView::heuristicZoom(int clickX, int clickY, qreal maxZoom)
{
...
/*!
    ...
    the Web engine.
*/
int QDeclarativeEditView::pressGrabTime() const
{
    return d->view->pressTime;
}

void QDeclarativeEditView::setPressGrabTime(int millis)
{
...
*/
QAction* QDeclarativeEditView::backAction() const
{
...
*/
QAction* QDeclarativeEditView::forwardAction() const
{
...
*/
QAction* QDeclarativeEditView::reloadAction() const
{
...
*/
QAction* QDeclarativeEditView::stopAction() const
{
...
*/
QString QDeclarativeEditView::title() const
{
...
*/
QPixmap QDeclarativeEditView::icon() const
{
...
*/
void QDeclarativeEditView::setStatusText(const QString& text)
{
    d->statusText = text;
    emit statusTextChanged();
}

void QDeclarativeEditView::windowObjectCleared()
{
    d->updateWindowObjects();
}

QString QDeclarativeEditView::statusText() const
{
    return d->statusText;
}

QWebPage* QDeclarativeEditView::page() const
{
    return d->view->page();
}
...
/*!
    ...
    \endqml
*/
QDeclarativeEditSettings* QDeclarativeEditView::settingsObject() const
{
    d->settings.s = page()->settings();
    return &d->settings;
}

void QDeclarativeEditView::setPage(QWebPage* page)
{
    if (d->view->page() == page)
        return;
...
void QDeclarativeEditView::load(const QNetworkRequest& request, QNetworkAccessManager::Operation operation, const QByteArray& body)
{
    page()->mainFrame()->load(request, operation, body);
}

QString QDeclarativeEditView::html() const
{
...
/*!
    ...
    \endqml
*/
void QDeclarativeEditView::setHtml(const QString& html, const QUrl& baseUrl)
{
    updateContentsSize();
    if (isComponentComplete())
...
void QDeclarativeEditView::setContent(const QByteArray& data, const QString& mimeType, const QUrl& baseUrl)
{
    updateContentsSize();
...
QWebHistory* QDeclarativeEditView::history() const
{
    return page()->history();
}

QWebSettings* QDeclarativeEditView::settings() const
{
    return page()->settings();
}

QDeclarativeEditView* QDeclarativeEditView::createWindow(QWebPage::WebWindowType type)
{
    switch (type) {
    case QWebPage::WebBrowserWindow: {
        if (!d->newWindowComponent && d->newWindowParent)
            ...
            QDeclarativeEditView* webview = 0;
            ...
            if (newObject) {
                ...
                if (!item)
                    ...
                    webview = item->findChild<QDeclarativeEditView*>();
                    if (!webview)
                        delete item;
                    else {
...
*/
QDeclarativeComponent* QDeclarativeEditView::newWindowComponent() const
{
    return d->newWindowComponent;
}

void QDeclarativeEditView::setNewWindowComponent(QDeclarativeComponent* newWindow)
{
...
*/
QDeclarativeItem* QDeclarativeEditView::newWindowParent() const
{
    return d->newWindowParent;
}

void QDeclarativeEditView::setNewWindowParent(QDeclarativeItem* parent)
{
...
QSize QDeclarativeEditView::contentsSize() const
{
    return page()->mainFrame()->contentsSize() * contentsScale();
}

qreal QDeclarativeEditView::contentsScale() const
{
    return d->view->scale();
}

void QDeclarativeEditView::setContentsScale(qreal scale)
{
...
QColor QDeclarativeEditView::backgroundColor() const
{
    return d->view->palette().base().color();
}

void QDeclarativeEditView::setBackgroundColor(const QColor& color)
{
...
*/
QRect QDeclarativeEditView::elementAreaAt(int x, int y, int maxWidth, int maxHeight) const
{
...
/*!
    ...
    \sa QDeclarativeEditView
*/
QDeclarativeEditPage::QDeclarativeEditPage(QDeclarativeEditView* parent) :
    QWebPage(parent)
{
...
QDeclarativeEditPage::~QDeclarativeEditPage()
{
}

QString QDeclarativeEditPage::chooseFile(QWebFrame* originatingFrame, const QString& oldFile)
{
...
void QDeclarativeEditPage::javaScriptAlert(QWebFrame* originatingFrame, const QString& msg)
{
    Q_UNUSED(originatingFrame)
    emit viewItem()->alert(msg);
}

bool QDeclarativeEditPage::javaScriptConfirm(QWebFrame* originatingFrame, const QString& msg)
{
    // Not supported (it's modal)
    Q_UNUSED(originatingFrame)
    Q_UNUSED(msg)
...
bool QDeclarativeEditPage::javaScriptPrompt(QWebFrame* originatingFrame, const QString& msg, const QString& defaultValue, QString* result)
{
    // Not supported (it's modal)
    Q_UNUSED(originatingFrame)
    Q_UNUSED(msg)
...
QDeclarativeEditView* QDeclarativeEditPage::viewItem()
{
    return static_cast<QDeclarativeEditView*>(parent());
}

QWebPage* QDeclarativeEditPage::createWindow(WebWindowType type)
{
    QDeclarativeEditView* newView = viewItem()->createWindow(type);
    if (newView)
        return newView->page();
    return 0;
}
